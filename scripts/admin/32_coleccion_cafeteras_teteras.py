#!/usr/bin/env python3
"""Lote 32 · colección «Cafeteras y teteras» (auditoría de enlaces 2026-09-23, §15 P0).
...
Deshacer: borrar la colección `cafeteras-teteras` en Admin.
    ...
    python3 32_coleccion_cafeteras_teteras.py           # ensayo
    python3 32_coleccion_cafeteras_teteras.py --apply   # aplica
"""
import argparse
...
def main():
    ...
    add_common_args(parser, "informe-32-coleccion-cafeteras-teteras.json")
    args = parser.parse_args()
    admin = Admin(apply=args.apply, strict=False)
    banner("Lote 32 · colección Cafeteras y teteras", admin)
